...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    if (method === 'GET' && url.includes('sync')) {
        try {
            ...
            // Always use the stored full token from DB
            ...
            if (!connections || connections.length === 0 || !connections[0].link_token || connections[0].link_token === '[object Object]') {
            ...
            console.log('[Sync] Using stored link_token:', linkToken.substring(0, 20) + '...');
